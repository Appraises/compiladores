...
public final class AComandoVazioComando extends PComando
{
    ...
    public Object clone()
    {
        return new AComandoVazioComando(
    ...
    {
        ((Analysis) sw).caseAComandoVazioComando(this);
    }
