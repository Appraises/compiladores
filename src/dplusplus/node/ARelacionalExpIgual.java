...
public final class ARelacionalExpIgual extends PExpIgual
{
    private PExpRelacional _expRelacional_;

    public ARelacionalExpIgual()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARelacionalExpIgual(
    ...
    {
        ((Analysis) sw).caseARelacionalExpIgual(this);
    }
