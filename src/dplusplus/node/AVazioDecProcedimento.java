...
public final class AVazioDecProcedimento extends PDecProcedimento
{
    ...
    public Object clone()
    {
        return new AVazioDecProcedimento(
    ...
    {
        ((Analysis) sw).caseAVazioDecProcedimento(this);
    }
