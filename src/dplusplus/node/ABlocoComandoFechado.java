...
public final class ABlocoComandoFechado extends PComandoFechado
{
    private PBloco _bloco_;

    public ABlocoComandoFechado()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlocoComandoFechado(
    ...
    {
        ((Analysis) sw).caseABlocoComandoFechado(this);
    }
