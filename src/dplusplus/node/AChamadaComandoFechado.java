...
public final class AChamadaComandoFechado extends PComandoFechado
{
    private PChamada _chamada_;
    private TPonto _ponto_;

    public AChamadaComandoFechado()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaComandoFechado(
    ...
    {
        ((Analysis) sw).caseAChamadaComandoFechado(this);
    }
